...
type
  TCustomThread = class
    ...
    public
      ...
      function ThreadStop(AWaitTillFinished: Boolean = FALSE): Boolean;
...
function TCustomThread.ThreadStop(AWaitTillFinished: Boolean = FALSE): Boolean;
var
  LWaitResult: DWORD;
begin
    ...
    begin
      ...
      begin
         LWaitResult := WaitForSingleObject(FFinishedEvent, INFINITE );
